...
if __name__ == '__main__':
    ...
    # TODO
    parser.add_argument('--modelname', type=str, default='model-6000.pb')
    ...
    if w == 0 or h == 0:
        e = TfPoseEstimator(args.modelname, target_size=(432, 368))
    else:
        e = TfPoseEstimator(args.modelname, target_size=(w, h))
